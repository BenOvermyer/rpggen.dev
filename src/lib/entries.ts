...
export function all(): Entry[] {
  return [
    new Entry(
      ...
      [
        new Link("Mercenary cost calculator", "https://5emagic.shop/mercenary-cost-calculator"),
        new Link("Wizard spellbook generator", "https://5emagic.shop/spellbook/generate"),
      ],
    ...
    new Entry(
      ...
      [
        new Link("Melee weapon fumbles", "https://www.5thdnd.com/melee-weapon"),
        new Link("Shield generator", "https://www.5thdnd.com/copy-of-armor"),
      ],
    ...
    new Entry(
      ...
      null,
      [
        new Link("D&D 5E encounter generator", "https://www.chaosgen.com/dnd5e/random-encounter/"),
        new Link("Adventuring group name generator", "https://www.chaosgen.com/fantasy/party-name"),
      ],
    ...
    new Entry(
      ...
      [
        new Link("Civilization generator", "http://chaoticshiny.com/civgen.php"),
        new Link("Holiday generator", "http://chaoticshiny.com/holidaygen.php"),
      ],
      ["fantasy"],
    ),
    new Entry(
    ...
    new Entry(
      ...
      null,
      [
        new Link("Building generator", "https://1-dot-encounter-planner.appspot.com/building-generator.html"),
        new Link(
          "World-shaking event generator",
          "https://1-dot-encounter-planner.appspot.com/world-shaking-event-generator.html",
        ),
      ],
      ["Dungeons & Dragons 5e", "fantasy"],
    ),
    new Entry(
      ...
      [
        new Link("Random disease generator", "http://dndspeak.com/2019/09/random-disease-generator/"),
        new Link("Random potion generator", "http://dndspeak.com/2019/06/random-potion-generator/"),
      ],
      ["fantasy"],
    ),
    new Entry(
    ...
    new Entry(
      ...
      null,
      [
        new Link("Constellation generator", "https://www.darkestofnights.com/gen_cons.php"),
        new Link("Art idea generator", "https://www.darkestofnights.com/gen_artidea.php"),
      ],
      [],
    ),
    new Entry(
    ...
    new Entry(
      ...
      [
        new Link("Sci-fi world generator", "Sci-fi world generator"),
        new Link("Random 5E dungeon generator", "https://donjon.bin.sh/5e/dungeon/"),
      ],
    ...
    new Entry(
      ...
      [
        new Link("City generator", "https://www.dungeonmastersvault.com/generator/citygenerator"),
        new Link("Rumor generator", "https://www.dungeonmastersvault.com/generator/rumorgenerator"),
      ],
      ["fantasy"],
    ),
    new Entry(
    ...
    new Entry(
      ...
      [
        new Link("Arcane babble generator", "http://enneadgames.com/generators-and-tools/arcane-babble-generator/"),
        new Link("Altar generator", "http://enneadgames.com/generators/dungeon-generator/altar-generator/"),
      ],
      ["fantasy"],
    ),
    new Entry(
      ...
      null,
      [
        new Link("Magic effects generator", "https://www.trollmystic.com/pub/2012/03/03/magic-effects-generator/"),
        new Link("Event generator", "https://www.trollmystic.com/pub/2012/03/03/event-generator/"),
      ],
      [],
    ),
    new Entry(
      ...
      [
        new Link("Critical miss generator", "https://everweird.app/category/critical-miss/"),
        new Link("Pocket filler", "https://everweird.app/category/item/pocket-filler/"),
      ],
      [],
    ),
    new Entry(
    ...
    new Entry(
      ...
      null,
      [
        new Link("Evil name generator", "https://www.fantasynamegenerators.com/evil_names.php"),
        new Link("Magic user names", "https://www.fantasynamegenerators.com/magic-user-names.php"),
      ],
      ["names"],
    ),
    new Entry(
      ...
      [
        new Link("Abhorrent artifacts", "https://glumdark.com/?tableUuid=23227adf7b08dc7dee20"),
        new Link("Extremely unexpected creatures", "https://glumdark.com/?tableUuid=f80a333a63618f52113d"),
      ],
      ["fantasy", "horror"],
    ),
    new Entry(
      ...
      [
        new Link("Dungeon battlemap generator", "https://www.gozzys.com/battlemap/dungeons"),
        new Link("Cave battlemap generator", "https://www.gozzys.com/battlemap/caves"),
      ],
      ["fantasy", "maps"],
    ),
    new Entry(
      ...
      null,
      [
        new Link("Character generator", "http://www.herebetaverns.com/characters"),
        new Link("Item generator", "http://www.herebetaverns.com/items"),
      ],
      [],
    ),
    new Entry(
    ...
    new Entry(
      ...
      [
        new Link("Culture generator", "https://ironarachne.com/#/culture"),
        new Link("Uncharted Worlds character generator", "https://ironarachne.com/#/unchartedworlds/character"),
      ],
      [
    ...
    new Entry(
      ...
      null,
      [
        new Link("Air odor generator", "https://jtevans.kilnar.com/rpg/dnd/tools/dress.php?input=2"),
        new Link("Mage furnishings generator", "https://jtevans.kilnar.com/rpg/dnd/tools/dress.php?input=9"),
      ],
      [],
    ),
    new Entry(
      ...
      [
        new Link("Backstory generator", "https://www.kassoon.com/dnd/backstory-generator/"),
        new Link("Interesting location generator", "https://www.kassoon.com/dnd/interesting-locations/"),
      ],
      [],
    ),
    new Entry(
    ...
    new Entry(
      ...
      null,
      [
        new Link("Magical girl generator", "https://generators.magicalgurll.com/original/magicalgirl.html"),
        new Link("Witch generator", "https://generators.magicalgurll.com/original/witch.html"),
      ],
      [],
    ),
    new Entry(
      ...
      null,
      [
        new Link("Inn and tavern name generator", "https://www.mithrilandmages.com/utilities/Inns.php"),
        new Link("Labyrinth Lord monster mangler", "https://www.mithrilandmages.com/utilities/LLMonsterMangler.php"),
      ],
      [],
    ),
    new Entry(
    ...
    new Entry(
      ...
      [
        new Link(
          "Sentient sword generator",
          "https://oldschoolessentials.necroticgnome.com/generators/sentient-sword-generator",
        ),
        new Link(
          "Treasure by dungeon level",
          "https://oldschoolessentials.necroticgnome.com/generators/treasure-by-dungeon-level-generator",
        ),
      ],
      ["Old School Revival"],
    ),
    ...
    new Entry(
      ...
      [
        ...
        new Link(
          ...
          "https://randomcreation.net/generators.html?token=3cc36c24a43949678c6ca652b106514a",
        ),
      ],
      [],
    ),
    new Entry(
      ...
      [
        new Link("Character archetype generator", "https://www.rangen.co.uk/chars/archegen.php"),
        new Link("Law generator", "https://www.rangen.co.uk/world/lawgen.php"),
      ],
      ["fantasy"],
    ),
    new Entry(
    ...
    new Entry(
      ...
      [
        new Link("Dragon name generator", "http://www.secretdoor.online/npc/dragons"),
        new Link("Lizardfolk name generator", "http://www.secretdoor.online/npc/lizard0"),
      ],
      ["fantasy", "names"],
    ),
    new Entry(
      ...
      [
        new Link("Tavern generator", "https://seriousd6.github.io/tavern.html"),
        new Link("Shopkeeper generator", "https://seriousd6.github.io/shopkeeper.html"),
      ],
      ["fantasy"],
    ),
    new Entry(
      ...
      [
        new Link(
          ...
          "https://www.seventhsanctum.com/generate.php?Genname=supervillaintheme",
        ),
        new Link("Super profession generator", "https://www.seventhsanctum.com/generate.php?Genname=superprofession"),
      ],
      ["fantasy", "superheroes"],
    ),
    new Entry(
      ...
      [
        new Link("Starship generator", "https://sfrpgtools.com/starship-generator"),
        new Link("Starfinder trap generator", "https://sfrpgtools.com/trap-generator"),
      ],
      ["sci-fi"],
    ),
    new Entry(
    ...
    new Entry(
      ...
      null,
      [
        new Link("Plant generator", "https://www.springhole.net/writing_roleplaying_randomators/plants.htm"),
        new Link("Humanoid race generator", "https://www.springhole.net/writing_roleplaying_randomators/humanoid.htm"),
      ],
      ["fantasy"],
    ),
    new Entry(
    ...
    new Entry(
      ...
      null,
      [
        new Link("One page dungeon generator", "https://watabou.itch.io/one-page-dungeon"),
        new Link("Perilous Shores", "https://watabou.itch.io/perilous-shores"),
      ],
      [],
    ),
    new Entry(
